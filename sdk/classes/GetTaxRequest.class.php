 ...
 */
    ...
    // The above code was causing an error when $this->Addresses was null
    // it has been refactored below to avoid this error
    if (is_array($this->Addresses)) {
      return $this->Addresses;
    } else {
      if (isset($this->Addresses->BaseAddress)) {
